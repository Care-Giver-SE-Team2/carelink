...
class ElderFamilyBindingJpaEntity {
	...
	protected ElderFamilyBindingJpaEntity() {
	}
	...
	boolean isIsPrimaryContact() {
		return isPrimaryContact;
	}

	void setIsPrimaryContact(boolean isPrimaryContact) {
	...
	void setAccessScope(AccessScope accessScope) {
