...
class CaregiverAvailabilityJpaEntity {
	...
	void setAvailableDate(LocalDate availableDate) {
		this.availableDate = availableDate;
	}

	LocalTime getAvailableStart() {
		return availableStart;
	}

	void setAvailableStart(LocalTime availableStart) {
		this.availableStart = availableStart;
	}

	LocalTime getAvailableEnd() {
		return availableEnd;
	}

	void setAvailableEnd(LocalTime availableEnd) {
